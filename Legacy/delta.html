	...
	<div class='bounding_box_topright'>
		<div class='info_panel'>
				...
				<div>
					...
					<li>Number in bubble is change in the latest Master Build Plan relative to the Original Build Plan for that metro area.</li>
					</ul>
				</div>
		</div>
		...
		<div class='control_panel'>
				...
				<div class='row' id='filters'>
					...
					<div class='row' id='chargerfilters'>
						Show MSAs with <input type='text' id='minchargers' name='minchargers' style='width:2.5em' value=-500> to <input type='text' id='maxchargers' name='maxchargers' style='width:2.5em' value=1000> chargers
					</div>
